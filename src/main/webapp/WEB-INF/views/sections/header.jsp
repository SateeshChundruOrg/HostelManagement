...
<div style="height: 90px; background: url(${pageContext.servletContext.contextPath}/resources/img/inner_header_bg.png) repeat-x;">
	<table style="width: 100%; height: 100%;" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td rowspan="2" style="width: 230px; vertical-align: middle; text-align: left;"><a href="${pageContext.servletContext.contextPath}/web" style="text-decoration: none;"><img border="0" alt="Effortless Field Force ORganizing &amp; Tracking" title="Effortless Field Force ORganizing &amp; Tracking" src="${pageContext.servletContext.contextPath}/resources/img/effort.png" width="390" height="65" style="border: 0px;"></a></td>
